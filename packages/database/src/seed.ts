...
async function main() {
    ...
    create: {
      ...
      settings: {
        aiConfig: {
          ...
          temperature: 0.3,
          toneInstructions:
            "Tono futbolero argentino, apasionado pero respetoso",
          enabled: true,
        },
      },
    },
  ...
  const rules = [
    ...
    },
    {
      ...
      actions: [
        { type: "ADD_TO_CAMPAIGN", params: { campaignId: "reactivation" } },
      ],
    },
    {
      ...
      conditions: {
        operator: "AND",
        conditions: [
          { field: "event.type", operator: "eq", value: "user.overtaken" },
        ],
      },
    ...
    },
    {
      ...
      conditions: {
        operator: "AND",
        conditions: [
          { field: "event.type", operator: "eq", value: "payment.pending" },
        ],
      },
    ...
    },
    {
      ...
      conditions: {
        operator: "AND",
        conditions: [
          { field: "event.type", operator: "eq", value: "new.leader" },
        ],
      },
  ...
  const templates = [
    {
      ...
      body: "Felicidades, estás en el top 3 del prode.",
    },
    {
      name: "goal_scored",
      channel: "sms",
      subject: "",
      body: "Gol de tu equipo! ${team} marcó.",
    },
    {
      name: "reactivation",
      channel: "email",
      subject: "Te echamos de menos",
      body: "Hace días que no jugas. Volvé al prode!",
    },
    {
      name: "overtaken",
      channel: "voice",
      subject: "",
      body: "Has sido superado en el ranking.",
    },
  ];
