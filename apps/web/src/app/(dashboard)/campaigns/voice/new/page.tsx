...
export default function NewVoiceCampaignPage() {
  ...
  const updateDTMFOption = (idx: number, field: keyof DTMFOption, value: string) => {
      ...
      <div className="space-y-6">
        ...
        <Card className="p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              />
              <p className="text-xs text-slate-500 mt-1">Natural language script. Supports Handlebars variables.</p>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-semibold text-slate-900">DTMF Options (Phone Key Presses)</h2>
                ...
                <div key={idx} className="flex gap-3 items-end">
                  <div className="flex-shrink-0">
                    ...
                    <input
                      ...
                      maxLength={1}
                      value={opt.key}
                      onChange={(e) => updateDTMFOption(idx, 'key', e.target.value.toUpperCase())}
                  ...
                  <div className="flex-1">
                    ...
                    <input
                      type="text"
                      value={opt.label}
                      onChange={(e) => updateDTMFOption(idx, 'label', e.target.value)}
