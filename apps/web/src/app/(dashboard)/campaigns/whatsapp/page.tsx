...
const mockCampaigns: WhatsAppCampaign[] = [
  {
    ...
    status: 'active',
    stats: { sent: 800, delivered: 750, read: 600, failed: 50 },
  ...
  },
  {
    ...
    status: 'completed',
    stats: { sent: 1200, delivered: 1180, read: 950, failed: 20 },
...
export default function WhatsAppCampaignsPage() {
  const [campaigns] = useState<WhatsAppCampaign[]>(mockCampaigns);
