...
skipIfNoDatabaseUrl("Event Ingestion Routes", () => {
  ...
  describe("POST /v1/events", () => {
    ...
    it("should automatically create user if not exists", async () => {
    ...
    it("should reject duplicate events with idempotencyKey", async () => {
    ...
    it("should reject events without authentication", async () => {
      const response = await app.inject({
        method: "POST",
        url: "/v1/events",
        headers: {},
  ...
  describe("POST /v1/events/batch", () => {
    ...
    it("should handle duplicate events in batch", async () => {
  ...
  describe("POST /v1/events/:eventId/replay", () => {
    it("should replay an event successfully", async () => {
